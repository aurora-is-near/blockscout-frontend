...
| NEXT_PUBLIC_CUSTOM_CSS_URL | `string` | URL to an external CSS file that will be injected into the page for custom styling. Allows complete UI customization via external stylesheets. | - | - | `https://example.com/custom-styles.css` | v2.3.0+ |
